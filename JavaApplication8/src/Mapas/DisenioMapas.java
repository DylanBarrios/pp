    ...
    public void MapaManual(int filas, int columnas, int planetasNeutrales, String Jugador1, String Jugador2) {
        ...
        for (int i = 0; i < filas; i++) {
            for (int j = 0; j < columnas; j++) {
                System.out.println("Que tipo de planeta desea en la posicon " + i + "," + j);
                System.out.println("1) Tierra");
                System.out.println("2) Fuego");
                System.out.println("3) Organico");
                System.out.println("4) Radioactivo");
                System.out.println("5) Agua");
                System.out.println("6) Sin planeta");
                int TipoPlaneta = leerInt.nextInt();
                System.out.println("Quien será el dueño del planeta ");
